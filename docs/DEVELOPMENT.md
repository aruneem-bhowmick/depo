...
└── components/
    ├── ConfirmGate.test.tsx     ConfirmGate: label/count rendering, singular/plural button text, correct/wrong input matching, whitespace rejection, animate-shake add/remove, loading state (12 cases)
